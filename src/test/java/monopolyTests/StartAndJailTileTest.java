...
public class StartAndJailTileTest {
    ...
    void ShouldGoToJail(){
        ...
        assertEquals(player1.getJailStatus(), 1, "Player should be in jail after landing on the GoToJailTile.");
    }
    ...
    void ShouldGetMoneyForLandingOnStart(){
        ...
        assertEquals(expectedMoney, player2.getBalance(), "Player should receive 2000 for passing the StartTile.");
    }
    ...
    void jailShouldNotBeActive(){
        ...
        assertEquals(player3.getJailStatus(), 0, "Player should not be in jail after landing on the StartTile.");
    }
    ...
    void jailShouldBeActive(){
        ...
        game.getBoard().getGameboard().get(player3.getPosition()).action(player3, game);
        assertEquals(player3.getJailStatus(), 2, "Player should not be in jail after landing on the StartTile.");
    }
}
